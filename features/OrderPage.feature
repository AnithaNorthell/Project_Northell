...
Feature: Order Page Functionality
  ...
  @Reg
  Scenario: validate left navigation bar on order page
    Given User navigates to login page
    When User enters username "testaccount.gamma@northell.com"
    And User enters password "TreeMaroonCharacter7531"
    And User clicks login button
  ...
  @Reg
  Scenario: Editing a file name updates the label in the left navigation list.
  ...
  @Reg 
  Scenario: Choosing 'Delete' opens a confirmation dialog before removal.
    Given User navigates to login page
    When User enters username "testaccount.gamma@northell.com"
    And User enters password "TreeMaroonCharacter7531"
    And User clicks login button
 ...
 @Reg
  Scenario: Bottom-left area shows user name and copyright text for Northell Partners
    Given User navigates to login page
    When User enters username "testaccount.gamma@northell.com"
    And User enters password "TreeMaroonCharacter7531"
    And User clicks login button
